...
class TransformerDecoder(DecoderBase):
    ...
    def from_opt(cls, opt, embeddings):
        ...
        return cls(
            ...
            opt.aan_useffn,
            opt.lambda_coverage>0.0) # LP) if this is greater than 0, the coverage loss will be used
    ...
    def forward(self, tgt, memory_bank, step=None, prev_key_contexts=None, **kwargs):
        ...
        cove_attn = torch.cumsum(attn, 1).transpose(0, 1).contiguous() # LP) accum. attn at each step for coverage loss
