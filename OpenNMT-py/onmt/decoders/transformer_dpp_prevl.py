...
from onmt.modules import MultiHeadedAttention, AverageAttention, MultiHeadedAttentionDPP
from onmt.modules.position_ffn import PositionwiseFeedForward
from onmt.utils.misc import sequence_mask

from onmt.decoders.transformer import TransformerDecoder

class TransformerDecoderLayerDPPPrevl(nn.Module):
    """
    Args:
    ...
    def __init__(self, d_model, heads, d_ff, dropout, attention_dropout,
        ...
        super(TransformerDecoderLayerDPPPrevl, self).__init__()
        ...
        self.context_attn = MultiHeadedAttentionDPP(
...
class TransformerDecoderDPPPrevl(TransformerDecoder):
    ...
    def __init__(self, num_layers, d_model, heads, d_ff,
        ...
        super(TransformerDecoderDPPPrevl, self).__init__(num_layers, d_model, heads, d_ff,
                 copy_attn, self_attn_type, dropout, attention_dropout,
        ...
        self.transformer_layers = nn.ModuleList(
            [TransformerDecoderLayerDPPPrevl(d_model, heads, d_ff, dropout,
