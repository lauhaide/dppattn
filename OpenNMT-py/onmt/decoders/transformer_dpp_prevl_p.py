...
from onmt.modules import MultiHeadedAttention, AverageAttention, MultiHeadedAttentionDPP_P
from onmt.modules.position_ffn import PositionwiseFeedForward
from onmt.utils.misc import sequence_mask

from onmt.decoders.transformer import TransformerDecoder

class TransformerDecoderLayerDPPPrevlP(nn.Module):
    """
    Args:
    ...
    def __init__(self, d_model, heads, d_ff, dropout, attention_dropout,
        ...
        super(TransformerDecoderLayerDPPPrevlP, self).__init__()
        ...
        self.context_attn = MultiHeadedAttentionDPP_P(
...
class TransformerDecoderDPPPrevlP(TransformerDecoder):
    ...
    def __init__(self, num_layers, d_model, heads, d_ff,
        ...
        super(TransformerDecoderDPPPrevlP, self).__init__(num_layers, d_model, heads, d_ff,
                 copy_attn, self_attn_type, dropout, attention_dropout,
        ...
        self.transformer_layers = nn.ModuleList(
            [TransformerDecoderLayerDPPPrevlP(d_model, heads, d_ff, dropout,
