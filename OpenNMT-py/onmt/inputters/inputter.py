...
def build_dataset_iter(corpus_type, fields, opt, is_train=True, multi=False):
    ...
    #dataset_paths=['../../data/multinews/OpenNMT-Py-input/film_r2r.train.2.pt',
    #               '../../data/multinews/OpenNMT-Py-input/film_r2r.train.3.pt',
    #               '../../data/multinews/OpenNMT-Py-input/film_r2r.train.4.pt',
    #               '../../data/multinews/OpenNMT-Py-input/film_r2r.train.5.pt',
    #               '../../data/multinews/OpenNMT-Py-input/film_r2r.train.0.pt',
    #               '../../data/multinews/OpenNMT-Py-input/film_r2r.train.1.pt']
