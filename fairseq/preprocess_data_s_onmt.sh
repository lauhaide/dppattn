...
DSTDIR=$CATEGORY'_tok_min5_L7.5k_tdtk_r2r_'$SRC_L_STR'_SS_4onmt' 
...
python my_preprocess.py --source-lang src --target-lang tgt \
  ...
  --singleSeq --L $SRC_L \
  --out-idx-train ${DATA}/ignoredIndices.log \
  --out-idx-valid ${DATA}/valid_ignoredIndices.log \
  --outfileTexts  1> data-bin/$DSTDIR/preprocess.log
